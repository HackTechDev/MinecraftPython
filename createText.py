...
class MinecraftTwitterStreamClient:
    def __init__(self, textBlock):
        ...
        self.mc.postToChat("Write text block: " + textBlock)
        #create my minecraft text screen object
        self.mcText = MinecraftText(self.mc)
        text = format(textBlock).encode('utf-8') 
        self.mcText.writeNextLine(text)

# http://www.stuffaboutcode.com/2013/08/raspberry-pi-minecraft-twitter.html
